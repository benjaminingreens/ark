...
install/update v0.1.0-alpha.2
```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/benjaminingreens/ark/v0.1.0-alpha.2/install.sh)"
```

install/update v0.1.0-alpha.2 on ish:
```bash
