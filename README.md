...
install/update v0.1.0-alpha.3
```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/benjaminingreens/ark/v0.1.0-alpha.3/install.sh)"
```

install/update v0.1.0-alpha.3 on ish:
```bash
