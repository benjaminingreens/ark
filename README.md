...
install/update v0.1.0-alpha.11
```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/benjaminingreens/ark/v0.1.0-alpha.11/install.sh)"
```

install/update v0.1.0-alpha.11 on ish:
```bash
